...
val s8 = State.parseSfenString("4B2nk/6G2/5pppp/7N1/9/9/9/9/9 b 2rb3g4s2n4l14p")

val r = MateSolver.solve(s8, timeLimitMillis = 30000)




r.get.map(_.toJapaneseNotationString)
