...
val g = Game(
  ...
  Stream(
    Move(BLACK,Square(16),Square(7),PKNIGHT,false,Some(KING),false,None),
    Move(WHITE,Square(-1),Square(9),PAWN,false,None,false,None),
    Move(BLACK,Square(34),Square(44),SILVER,false,None,false,None),
    Move(WHITE,Square(12),Square(20),GOLD,false,Some(PPAWN),false,Some(9246)),
    Move(BLACK,Square(-1),Square(32),KING,false,None,false,Some(7791)),
    Move(WHITE,Square(15),Square(13),ROOK,false,Some(PKNIGHT),false,None),
    Move(BLACK,Square(32),Square(40),KING,false,Some(ROOK),false,Some(2860)),
    Move(WHITE,Square(-1),Square(14),KNIGHT,false,None,false,None),
    Move(BLACK,Square(28),Square(20),BISHOP,false,Some(GOLD),false,None),
    Move(WHITE,Square(14),Square(33),KNIGHT,false,None,false,None),
    Move(BLACK,Square(-1),Square(16),GOLD,false,None,false,Some(834)),
    Move(WHITE,Square(33),Square(50),KNIGHT,false,None,false,None),
    Move(BLACK,Square(37),Square(10),LANCE,false,Some(PAWN),false,None),
    Move(WHITE,Square(-1),Square(37),PAWN,false,None,false,Some(6948)),
    Move(BLACK,Square(58),Square(68),SILVER,false,None,false,None),
    Move(WHITE,Square(50),Square(69),PKNIGHT,true,Some(LANCE),false,Some(6624)), Move(BLACK,Square(-1),Square(32),ROOK,false,None,false,None), Move(WHITE,Square(-1),Square(31),LANCE,false,None,true,None), Move(BLACK,Square(40),Square(50),KING,false,None,false,None), Move(WHITE,Square(24),Square(23),PPAWN,false,None,false,None), Move(BLACK,Square(68),Square(76),SILVER,false,None,false,None), Move(WHITE,Square(67),Square(76),PSILVER,false,Some(SILVER),false,None), Move(BLACK,Square(49),Square(40),PAWN,false,None,false,Some(9861)), Move(WHITE,Square(8),Square(16),GOLD,false,Some(GOLD),false,Some(1274)), Move(BLACK,Square(11),Square(12),GOLD,false,None,false,Some(4101)), Move(WHITE,Square(47),Square(56),PAWN,false,None,false,None), Move(BLACK,Square(48),Square(58),KING,false,None,false,None), Move(WHITE,Square(-1),Square(54),SILVER,false,None,false,None), Move(BLACK,Square(12),Square(13),GOLD,false,Some(ROOK),false,None), Move(WHITE,Square(-1),Square(21),GOLD,false,None,false,Some(2203)), Move(BLACK,Square(-1),Square(19),PAWN,false,None,false,None), Move(WHITE,Square(31),Square(40),LANCE,false,Some(PAWN),false,Some(5749))),
  GameInfo(Map(
    'formatVersion -> "2.2",
